...
static const char WEAPON_NAME[WEAPON_COUNT][20]  = {
    "None","Solar Core","Lunar Blade","Iron Halberd",
    "Venom Dagger","Thunderstaff","Obsidian Axe",
    "Frostbow","Splinter Stick","Eclipse Relic"
};
static const char WEAPON_SHORT[WEAPON_COUNT][4] = {
